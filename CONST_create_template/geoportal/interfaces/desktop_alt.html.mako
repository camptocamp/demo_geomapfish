...
<html lang="{{mainCtrl.lang}}" ng-controller="AlternativeDesktopController as mainCtrl" ng-strict-di>
  ...
  <div ng-show="mainCtrl.loading" class="loading-mask">
    ...
    <gmf-desktop-canvas>
      ...
      <div slot="tool-panel-mapillary" class="row pointer-events-none gmf-mapillary-panel">
        <div class="col-sm-12">
          <div class="gmf-app-tools-content-heading">
      ...
      <gmf-mouseposition slot="infobar-right" gmf-mouseposition-map="mainCtrl.map" class="text-center" class="gmf-app-footer-div">
      </gmf-mouseposition>
