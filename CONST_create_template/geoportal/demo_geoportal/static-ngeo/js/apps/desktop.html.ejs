...
<html lang="{{mainCtrl.lang}}" ng-app="AppDesktop" ng-controller="DesktopController as mainCtrl">
  <head>
    ...
    <link rel="stylesheet" href="${request.static_url('demo_geoportal:static-ngeo/build/desktop.css')}" type="text/css">
    <script>
  ...
  <body ng-class="{'gmf-profile-chart-active': !!profileChartActive}">
    <header>
      <div class="logo">
        <img src="${request.static_url('demo_geoportal:static-ngeo/images/logo.png')}" />
        ...
        <div class="gmf-app-map-bottom-controls">
          <div class="gmf-backgroundlayerbutton btn-group dropup">
            <button
                ...
                data-toggle="dropdown">
              <img src="${request.static_url('demo_geoportal:static-ngeo/images/background-layer-button.png')}" />
            </button>
    ...
    <script>
        goog.require('demo.desktop.Controller');
    </script>
...
% else:
    <script src="${request.static_url('demo_geoportal:static-ngeo/build/desktop.js')}"></script>
% endif
    <script>
...
${ ',\n'.join([
    ...
    for lang in request.registry.settings["available_locale_names"]
        ...
        var module = angular.module('AppDesktop');
        ...
        module.constant('fulltextsearchUrl', '${request.route_url('fulltextsearch', _query={"limit": "30", "partitionlimit": "5", "interface": "desktop"}) | n}');
        ...
        module.constant('gmfTreeUrl', '${request.route_url('themes', _query={"version": "2", "background": "background", "interface": "desktop"}) | n}');
