...
% else:
    var INITIAL_EXTENT = ["489246", "78873", "837119", "296543"];
% endif
    var RESTRICTED_EXTENT = ["489246", "78873", "837119", "296543"];
            ...
            controls: [
                ...
                new OpenLayers.Control.OverviewMap({
                    ...
                    layers: [new OpenLayers.Layer.Image(
                        "Overview Map",
                        "${request.static_url('demo:static/images/overviewmap.png') | n}",
