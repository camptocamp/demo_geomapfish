Ext.onReady(function() {
    ...
    OpenLayers.ImgPath = "${request.static_url('c2cgeoportal:static/lib/cgxp/core/src/theme/img/ol/')}";
    Ext.BLANK_IMAGE_URL = "${request.static_url('c2cgeoportal:static/lib/cgxp/ext/Ext/resources/images/default/s.gif')}";
            ...
            controls: [
                ...
                return new OpenLayers.Control.OverviewMap({
                    ...
                    layers: [new OpenLayers.Layer.Image(
                        "Overview Map",
                        "${request.static_url('c2cgeoportal:static/images/overviewmap.png')}",
